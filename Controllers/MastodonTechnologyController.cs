...
namespace ArtworkInbox.Controllers {
    public class MastodonTechnologyController : FeedController {
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly ApplicationDbContext _context;
        private readonly ILogger<HomeController> _logger;

        public MastodonTechnologyController(UserManager<ApplicationUser> userManager, ApplicationDbContext context, ILogger<HomeController> logger) {
        ...
        protected override string GetSiteName() => "mastodon.technology";

        protected override async Task<FeedSource> GetFeedSourceAsync() {
            var userId = _userManager.GetUserId(User);
            var dbToken = await _context.UserMastodonTechnologyTokens
        ...
        protected override async Task<DateTimeOffset> GetLastRead() {
            ...
            var dt = await _context.UserReadMarkers
                .Where(t => t.UserId == userId)
                .Select(t => t.MastodonTechnologyLastRead)
                .SingleOrDefaultAsync();
        ...
        protected override async Task SetLastRead(DateTimeOffset lastRead) {
            ...
            o.MastodonTechnologyLastRead = lastRead;
